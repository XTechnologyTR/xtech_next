      ...
      <Container sx={styles.banner.container}>
        <Box sx={styles.banner.contentBox}>
          <Heading as="h1" variant="heroPrimary">
            Artık tüm kontrol sizin elinizde, hemde haberi bile olmadan...
          </Heading>
          <Text as="p" variant="heroSecondary">
            X Takip telefon dinleme programını kullanarak, sevdiklerinizin her daim yanında olacaksınız.
            Tüm yaptıklarından haberdar olacak ve onların güvenliklerini sağlayabileceksiniz.
          </Text>
          <Subscribe />
